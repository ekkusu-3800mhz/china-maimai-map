...
<html lang="zh_CN">
    <head>
        ...
        <style type="text/css">body{padding-top:70px;font-family:"Noto Sans CJK SC",微软雅黑,Arial,黑体,宋体,sans-serif!important}div.count-panel>div.panel-body{text-align:center}div.count-panel>div.panel-body>div.row>div.count-cell>p.count-num{font-size:48px;font-weight:bold;padding-bottom:5px}div.count-panel>div.panel-body>div.row>div.count-cell{padding-top:20px;padding-bottom:20px}.table{margin-bottom:0}</style>
        <!--[if lt IE 9]>
